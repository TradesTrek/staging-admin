...
function getUserWatchList(search,page,option) {
  return fetchWrapper
    .post(`${baseUrl}/admin/user/watchlist?search=${search}&page=${page}&option=${JSON.stringify(option)}`)
    .then((res) => {
      return res;
    })
    .catch(function (error) {
...
function getUserPriceAlerts(search,page,option) {
  return fetchWrapper
    .post(`${baseUrl}/admin/user/priceAlert?search=${search}&page=${page}&option=${JSON.stringify(option)}`)
    .then((res) => {
      return res;
    })
    .catch(function (error) {
