      ...
      <div className="dashboard sideBarOpen">
        ...
        <div className="contentWrapper">
          <div className="dashboard_content">
            <h1 className="dashboard__title">All Holiday</h1>
                ...
                <thead>
                  <tr>
                    ...
                    <th
                      ...
                      onClick={() => {
                        setOption({
                          holidayName: option.holidayName == 1 ? -1 : 1,
                        });
                        setTableAction(false)
                    ...
                    <th
                      ...
                      onClick={() => {
                        setOption({
                          holidayMessage: option.holidayMessage == 1 ? -1 : 1,
                        });
                        setTableAction(false)
                      }}
                    >
                    ...
                    holiday.map((item, i) => {
                      return (
                        <tr key={i}>
                          ...
                          <td onClick={()=>setTableAction(false)}>{item.holidayName}</td>
                          <td onClick={()=>setTableAction(false)}>{item.holidayDate}</td>
                          <td onClick={()=>setTableAction(false)}>{item.holidayMessage}</td>
