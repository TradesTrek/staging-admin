...
import AddHoliday from "../../components/exchange/AddExchange";
...
export default function AllUsers() {
 ...
 let response = await stockService.deleteExchange(userId);
 if (response.success) {
 ...
 <h1 className="dashboard__title">All Exchanges</h1>
