...
export default function AllUsers() {
  ...
  const getHoliday = (search, page, data) => {
    setIsLoading(true);
    userService
      .getUserPriceAlerts(search, page, data)
      .then((res) => {
        if (res.success) {
      ...
      <div className="dashboard sideBarOpen">
        ...
        <div className="contentWrapper">
          <div className="dashboard_content">
            <h1 className="dashboard__title">All Price Alerts</h1>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th
                        ...
                        onClick={() => {
                          setOption({
                            hasNotified: option.hasNotified == 1 ? -1 : 1,
                          });
                          setTableAction(false);
                        }}
                      >
                      ...
                      <th
                        ...
                        onClick={() => {
                          setOption({
                            targetPrice: option.targetPrice == 1 ? -1 : 1,
                          });
                          setTableAction(false);
                        }}
                      >
