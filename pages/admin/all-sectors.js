...
import AddHoliday from "../../components/sector/AddSector";
import EditHoliday from "../../components/sector/EditSector";
...
export default function AllUsers() {
  ...
  const deleteUser = async (sectorId) => {
    let response = await stockService.deleteSector(sectorId);
    if (response.success) {
      ...
      <div className="dashboard sideBarOpen">
        ...
        <div className="contentWrapper">
          <div className="dashboard_content">
            <h1 className="dashboard__title">All Sectors</h1>
                    ...
                    holiday.map((item, i) => {
                      return (
                        <tr key={i}>
                          ...
                          <td onClick={()=>setTableAction(false)}>{item.category}</td>
