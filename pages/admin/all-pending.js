...
export default function AllPendingOrder() {
  ...
  const getPendingOrder = (page, str, op) => {
    setIsLoading(true);
    orderService
      .getAllPendingOrder(page, str, op)
      .then((res) => {
        if (res.success) {
  ...
  const downloadPending = async (str) => {
    const { data } = await orderService.downloadPendingOrder(search, option);
    ...
    if (str == "csv") {
      ...
      ExportExcel(PendingHeaders, data, "pending");
      setXlsxDownloading(false);
    } else if (str == "pdf") {
      ExportPdf(PendingHeaders, data, "pending");
      ...
      <div className="dashboard sideBarOpen">
        ...
        <div className="contentWrapper">
          <div className="dashboard_content">
            <h1 className="dashboard__title">All Pending Order</h1>
